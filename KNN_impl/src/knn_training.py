...
def run_knn(task_name, X_train, y_train, X_test, y_test, target_names, k_values, log_file):
    ...
    return best_f1, best_model, best_k, best_pca
...
try:
    ...
    best_plant_f1, best_plant_model, best_plant_k, best_plant_pca = run_knn(
    ...
    if best_plant_model:
        ...
        joblib.dump(best_plant_pca, os.path.join(MODELS_DIR, "pca_plant.pkl"))
...
for plant_name, disease_dict in disease_map.items():
    ...
    try:
        ...
        best_dis_f1, best_dis_model, best_dis_k, best_dis_pca = run_knn(
        ...
        if best_dis_model:
            ...
            joblib.dump(best_dis_pca, os.path.join(MODELS_DIR, f"pca_{task_name}.pkl"))

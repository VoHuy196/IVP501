...
feature_dir = Path(r"D:\XLHA\IVP501\IVP501\SVM_impl\input_vectors")
...
# ========== LOAD DATASET ==========
def main():
    # Bạn kiểm tra lại đường dẫn này cho chuẩn với máy bạn nhé
    dataset_path = r"D:\IVP501\plantvillage dataset\color"
    ...
    # ==========================================
    # ĐOẠN NÀY ĐÃ ĐƯỢC KÉO RA NGOÀI VÒNG LẶP FOR
    # ==========================================
    print("\n Dang tong hop du lieu, vui long cho...")
    ...
    print("\n [DONE] Du lieu duoc trich xuat thanh cong và luu vao muc input_vectors!\n")
